...
import { SectionContainer, SectionContent, SectionTitle } from '@/core/styles/pages/contact.styles';
  ...
  const infoItems = [
    {
      icon: '📍',
      title: 'Adresse',
      content: contacts?.address.full
    },
    {
      icon: '📞',
      title: 'Téléphone',
      content: contacts?.phone.display
    },
    {
      icon: '✉️',
      title: 'Email',
      content: contacts?.email.primary
    },
    {
      icon: '🕒',
      title: 'Horaires',
      content: `${contacts.hours.days} - ${contacts.hours.time}`
    }
  ];
