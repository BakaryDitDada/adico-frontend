...
export default function NewsHero() {
  ...
  return (
    ...
    //   <HeroContent>
    <PageHero
      subtitle="Information & Sensibilisation"
      bgImage="/images/actualités.jpg"
      align="center"
    >
      <motion.div
      ...
      >
        ...
        <HeroDescription>
          Restez informé des dernières nouvelles, projets et développements. Suivez notre impact en temps réel.
        </HeroDescription>
