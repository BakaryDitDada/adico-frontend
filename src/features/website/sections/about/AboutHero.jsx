...
import { selectCurrentTheme } from '@/core/store/globalSlice';
import {
  Building2,
  ChevronRight,
  Play,
...
import VideoModal from '@/core/ui/modals/VideoModal';
import { useSelector } from 'react-redux';

import { aboutHeroData } from '@/core/data/aboutContent';
    ...
    <>
      ...
      <S.HeroContainer ref={ref}>
        ...
        <S.HeroContent>
          <S.ContentGrid>
            <S.TextContent>
              <S.GlitchText data-text={eyebrow}>
                <motion.span
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
              ...
              >
                ...
                <br />
                {titleSuffix.includes('1993') ? (
                  <>
                    Depuis{' '}
                    <span className="gradient-text">1993</span>
                  </>
                ) : (
                  titleSuffix
                )}
              ...
              >
                ...
                >
                  <iframe
                    ...
                    width="100%"
                    height="100%"
                    src={`https://www.youtube.com/embed/${video.youtubeId}?enablejsapi=1&autoplay=0&mute=1&controls=0&rel=0&modestbranding=1&playsinline=1`}
                    title={video.title}
                    frameBorder="0"
