...
import { flexCenter, flexColumn } from '../../../core/styles/mixins/flexbox';
...
export const SlideContent = styled.div`
  position: relative;
  z-index: 3;
  color: ${props => props.theme.colors.surface.page};
    ...
    switch (props.$variant) {
      ...
      case 'outline':
        return `
          ...
          color: ${props.theme.colors.text.inverse};
          // border: 2px solid ${props.theme.colors.text.inverse};
