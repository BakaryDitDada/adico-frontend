...
import { useSearchEmployeesQuery } from '@/core/store/features/employees/employeesApi';
import { useSearchProjectsQuery } from '@/core/store/features/projects/projectsApi';

import { taskSchema, updateTaskSchema } from '@/core/schemas/taskSchema';

import * as S from '../Modal.styles'; // you can keep the same modal styles
import AsyncSearchSelect from '@/core/ui/forms/AsyncSearchSelect';
